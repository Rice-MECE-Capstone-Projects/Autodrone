...
(cl:in-package fusion_sensor-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <MyArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MyArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fusion_sensor-msg:<MyArray> is deprecated: use fusion_sensor-msg:MyArray instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <MyArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fusion_sensor-msg:header-val is deprecated.  Use fusion_sensor-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <MyArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fusion_sensor-msg:data-val is deprecated.  Use fusion_sensor-msg:data instead.")
  (data m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<MyArray>)))
  ...
  (cl:format cl:nil "# MymArray.msg~%std_msgs/Header header~%float64[] data~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'MyArray)))
  "Returns full string definition for message of type 'MyArray"
  (cl:format cl:nil "# MymArray.msg~%std_msgs/Header header~%float64[] data~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
