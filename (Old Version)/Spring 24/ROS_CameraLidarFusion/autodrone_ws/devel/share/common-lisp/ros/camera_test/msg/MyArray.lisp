...
(cl:defmethod cl:initialize-instance :after ((m <MyArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MyArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name camera_test-msg:<MyArray> is deprecated: use camera_test-msg:MyArray instead.")))
...
(cl:defmethod data-val ((m <MyArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader camera_test-msg:data-val is deprecated.  Use camera_test-msg:data instead.")
  (data m))
