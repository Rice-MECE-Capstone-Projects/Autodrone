...
set(MSG_I_FLAGS "-Ifusion_sensor:/home/autodrone/autodrone_folder/autodrone_ws/src/fusion_sensor/msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/autodrone/autodrone_folder/autodrone_ws/src/fusion_sensor/msg/MyArray.msg" NAME_WE)
add_custom_target(_fusion_sensor_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "fusion_sensor" "/home/autodrone/autodrone_folder/autodrone_ws/src/fusion_sensor/msg/MyArray.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(fusion_sensor
  "/home/autodrone/autodrone_folder/autodrone_ws/src/fusion_sensor/msg/MyArray.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/fusion_sensor)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/fusion_sensor\")")
  # install generated code
  install(
